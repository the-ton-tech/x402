...
ZERO_BIT_PAYLOAD_B64 = base64.b64encode(begin_cell().store_bit(0).end_cell().to_boc()).decode(
    "ascii"
)
...
class TestEnhancePaymentRequirements:
    ...
    def test_should_raise_when_custom_asset_decimal_amount_has_no_decimals_metadata(self):
        ...
        with pytest.raises(ValueError, match="provide amount in atomic units or extra.decimals"):
